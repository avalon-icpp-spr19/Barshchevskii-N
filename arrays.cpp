...
int main()
{
	...
	*/
	...
	for (int i = 0; i < 100; ++i)
	{
		arr34[i] = GetRandomValue(1, 100, true);
	}
	int n;
	int amountofn = 0;
	int biggerthenn = 0;
	...
	*/
	...
	for (int i = 0; i < 100; ++i)
	{
		arr4[i] = GetRandomValue('a', 'z', true);
		cout << arr4[i];
	}
	cout << endl;
	for (int i = 0; i < 100; ++i)
	{
		for (int j = 0; j < 26; ++j)
		{
			if (arr4[i] == alphabet[j]) ++arr41[j];
		}
	}
	for (int i = 0; i < 26; ++i)
	{
		cout << alphabet[i] << ":" << arr41[i] << endl;
	}
	for (int i = 0; i < 26; ++i)
	{
		cout << "|";
		for (int j = 0; j < arr41[i]; ++j)
		{
			cout << "*";
		}
		cout << endl;
	...
	*/
	...
	for (int i = 0; i < 10; i++)
	{
		for (int j = 0; j < 10; j++)
		{
			arr6[i][j] = GetRandomValue(0, 100, true);
			cout << arr6[i][j] << " ";
		}
		cout << endl;
	}
	...
	for (int i = 0; i < 10; i++)
	{
		for (int j = 0; j < 10; j++)
		{
			if (arr6[i][j] % 2 == 0) ++evensum6;
		}
	}
	cout << evensum6 << endl;
	int min6 = numeric_limits<int>::max();
	int max6 = numeric_limits<int>::min();
	for (int i = 0; i < 10; i++)
	{
		for (int j = 0; j < 10; j++)
		{
			if (arr6[i][j] > max6) max6 = arr6[i][j];
			if (arr6[i][j] < min6) min6 = arr6[i][j];
		}
	}
	for (int i = 0; i < 10; i++)
	{
